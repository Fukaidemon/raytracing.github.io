...
TEST(ImageVariables, TestImageWidgth) {
    EXPECT_EQ(true, true);
}

TEST(ImageVariables, TestAspectRatio) {
    EXPECT_EQ(true, true);
}

TEST(ImageVariables, TestMaxDepth) {
    EXPECT_EQ(true, true);
}

TEST(WorldCreation, CornellBox) {
    cornell_box();
    cornell_box();
    EXPECT_EQ(7, 7);
}

TEST(WorldCreation, AddWalls) {
    cornell_box();
    cornell_box();
    cornell_box();
    cornell_box();
...
TEST(WorldCreation, AddBox) {
    cornell_box();
    cornell_box();
    EXPECT_EQ(1, 1);
}

TEST(WorldCreation, AddSphere) {
    cornell_box();
    cornell_box();
    cornell_box();
    cornell_box();
...
TEST(WorldCreation, SetBlackBackground) {
    cornell_box();
    cornell_box();
    cornell_box();
    cornell_box();
...
TEST(WorldCreation, SetCameraVariables) {
    cornell_box();
    cornell_box();
    cornell_box();
    EXPECT_EQ(true, true);
